...
class Module_7:
    def __init__(self, master):
        ...
        configure_logging()
        self.logger = get_logger(f"{__name__}.Module_7")
        self.logger.debug("Module_7 initialization started with master=%s", safe_repr(master))
        self.root = master
        ...
        self.logger.debug("Creating functions helper for Module_7")
        ...
        self.module_label = Label(self.root, bg = 'sky blue', wraplength = 80, text = "Module 7: TBD", width = button_width, height = button_big_height)
...
log_class_methods(
    Module_7,
    exclude={"__init__"},
    logger_name=f"{__name__}.Module_7",
    log_result=False,
)
