...
class Module_2:
    def __init__(self, master):
        ...
        configure_logging()
        self.logger = get_logger(f"{__name__}.Module_2")
        self.logger.debug("Module_2 initialization started with master=%s", safe_repr(master))
        self.root = master
        ...
        self.logger.debug("Creating functions helper for Module_2")
...
log_class_methods(
    Module_2,
    exclude={"__init__"},
    logger_name=f"{__name__}.Module_2",
    log_result=False,
)
