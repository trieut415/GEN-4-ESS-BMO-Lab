...
class Module_6:
    def __init__(self, master):
        ...
        configure_logging()
        self.logger = get_logger(f"{__name__}.Module_6")
        self.logger.debug("Module_6 initialization started with master=%s", safe_repr(master))
        self.root = master
        ...
        self.logger.debug("Creating functions helper for Module_6")
        ...
        self.module_label = Label(self.root, bg = 'sky blue', wraplength = 80, text = "Module 6: TBD", width = button_width, height = button_big_height)
...
log_class_methods(
    Module_6,
    exclude={"__init__"},
    logger_name=f"{__name__}.Module_6",
    log_result=False,
)
