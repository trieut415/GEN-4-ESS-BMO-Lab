...
class Module_3:
    def __init__(self, master):
        ...
        configure_logging()
        self.logger = get_logger(f"{__name__}.Module_3")
        self.logger.debug("Module_3 initialization started with master=%s", safe_repr(master))
        self.root = master
        ...
        self.logger.debug("Creating functions helper for Module_3")
        ...
        self.module_label = Label(self.root, bg = 'sky blue', wraplength = 80, text = "Module 3: Fluorescence ESS", width = button_width, height = button_big_height)
...
log_class_methods(
    Module_3,
    exclude={"__init__"},
    logger_name=f"{__name__}.Module_3",
    log_result=False,
)
