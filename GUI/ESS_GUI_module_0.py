...
class Module_0:
    def __init__(self, master):
        ...
        self.graph_frame.grid(row = 1, column = 1, columnspan = 4, rowspan = 4, padx = 2, pady = 2, sticky = sticky_to)
        ...
        self.quit_button.grid(row = 0, column = 3, padx = 1, sticky = sticky_to)
...
#        self.help_button.grid(row = 0, column = 5, sticky = sticky_to)
        ...
        self.settings_button.grid(row = 0, column = 2, padx = (1,1), sticky = sticky_to)
...
#        self.save_spectra_button.grid(row = 0, column = 3, padx = (1,1), sticky = sticky_to)
        ...
        self.open_new_button = Button(self.root, text = "New Experiment", wraplength = 80, fg = 'black', command = self.open_experiment, width = button_width, height = button_big_height)
        self.open_new_button.grid(row = 0, column = 0, sticky = sticky_to)
        ...
        self.open_experiment_button.grid(row = 5, column = 1, padx = (2,1), sticky = sticky_to)

        self.acquire_button = Button(self.root, text = "Acquire", wraplength = 80, fg = 'black', command = lambda: self.func.acquire(save = False), width = button_width, height = 3)
        self.acquire_button.grid(row = 1, column = 0, pady = (2,1), sticky = sticky_to)

#        self.acquire_save_button = Button(self.root, text = "Acquire and Save", fg = 'black', wraplength = 80, command = self.check_scan_number, width = button_width, height = button_big_height, state = NORMAL)
#        self.acquire_save_button.grid(row = 1, column = 0, pady = (2,1), sticky = sticky_to)
...
#        self.sequence_save_button.grid(row = 4, column = 0, rowspan = 2, pady = 1, sticky = sticky_to)

        self.autorange_button = Button(self.root, text = "Autorange", fg = 'black', wraplength = 80, command = self.func.autorange,width = button_width, height = button_big_height)
        self.autorange_button.grid(row = 2, column = 0, rowspan = 2, pady = 1, sticky = sticky_to)

        self.autorange_save_button = Button(self.root, text = "Autorange + Sequence & Save", fg = 'black', wraplength = 80, command = self.check_auto_seq_number,width = button_width, height = button_big_height)
        self.autorange_save_button.grid(row = 4, column = 0, rowspan = 2, pady = 1, sticky = sticky_to)
...
#        self.sequence_button.grid(row = 5, column = 0, sticky = sticky_to)
        ...
        self.save_reference_button.grid(row = 0, column = 1, padx = (2,1), sticky = sticky_to)
...
#        self.ratio_view_button.grid(row = 5, column = 1, padx = (2,1), sticky = sticky_to)

        self.autoscale_button = Button(self.root, text = "Autoscale", fg = 'black', wraplength = 80, command = self.autoscale_toggle, width = button_width, height = button_big_height)
        self.autoscale_button.grid(row = 5, column = 3, padx = 1, sticky = sticky_to)
...
#        self.plot_selected_button.grid(row = 5, column = 3, padx = 1, sticky = sticky_to)

        self.clear_button = Button(self.root, text = "Clear", fg = 'black', wraplength = 80, command = self.func.clear, width = button_width, height = button_big_height)
        self.clear_button.grid(row = 5, column = 2, padx = 1, sticky = sticky_to)
...
#        self.add_remove_button.grid(row = 4, column = 4, columnspan = 2, padx = 5, pady = 1, sticky = sticky_to)

        module_label = Label(self.root, bg = 'black', text = module_message, wraplength = 80, font = label_font, fg='white')
        module_label.grid(row = 5, column = 4, padx = (1,2),  sticky = sticky_to)

        self.scan_label = Label(self.root, bg = 'black', text = "Scan: ", wraplength = 80, fg='white')
        self.scan_label.grid(row = 0, column = 4, padx = 5, pady = 1, sticky = 'nsew')


        self.battery_frame = Frame(self.root, bg = 'black', width = 4)
        self.battery_frame.grid(row = 0, column = 4, padx = (1,2), pady = 1, sticky = 'nsew')

        battery_width = 6

        self.battery_label_1 = Label(self.battery_frame, bg = "#315E26", height = 1, width = battery_width)
        self.battery_label_1.grid(row = 0, column = 0, padx = 1, sticky = 'nsew')

        self.battery_label_2 = Label(self.battery_frame, text = "%", font = battery_font, height = 1, bg = "#315E26", width = battery_width)
        self.battery_label_2.grid(row = 1, column = 0, padx = 1, sticky = 'nsew')

        self.battery_label_3 = Label(self.battery_frame, bg = "#315E26", height = 1,width = battery_width)
        self.battery_label_3.grid(row = 2, column = 0, padx = 1, sticky = 'nsew')

        self.battery_label_4 = Label(self.battery_frame, bg = "#315E26",height = 1, width = battery_width)
        self.battery_label_4.grid(row = 3, column = 0, padx = 1, sticky = 'nsew')

        self.scan_label = Label(self.battery_frame, bg = 'black', text = "Scan: ", fg='white', font = battery_font, height = 1, width = battery_width, wraplength = 80)
    ...
    def check_auto_seq_number(self):
        message = self.func.autorange_save()
        self.scan_label.config(text = message)
