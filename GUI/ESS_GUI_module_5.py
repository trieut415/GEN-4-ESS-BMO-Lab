...
class Module_5:
    def __init__(self, master):
        ...
        configure_logging()
        self.logger = get_logger(f"{__name__}.Module_5")
        self.logger.debug("Module_5 initialization started with master=%s", safe_repr(master))
        self.root = master
        ...
        self.logger.debug("Creating functions helper for Module_5")
...
log_class_methods(
    Module_5,
    exclude={"__init__"},
    logger_name=f"{__name__}.Module_5",
    log_result=False,
)
